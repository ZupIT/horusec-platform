...
type Vulnerability struct {
	...
	CriticalUnknown       int       `json:"criticalUnknown" gorm:"Column:critical_unknown"`
	...
	HighUnknown           int       `json:"highUnknown" gorm:"Column:high_unknown"`
	...
	MediumUnknown         int       `json:"mediumUnknown" gorm:"Column:medium_unknown"`
	...
	LowUnknown            int       `json:"lowUnknown" gorm:"Column:low_unknown"`
	...
	InfoUnknown           int       `json:"infoUnknown" gorm:"Column:info_unknown"`
	...
	UnknownUnknown        int       `json:"unknownUnknown" gorm:"Column:unknown_unknown"`
}
...
func (v *Vulnerability) AddCountVulnerabilityBySeverity(count int, severity severities.Severity, vulnType vulnerability.Type) {
	switch severity {
...
func (v *Vulnerability) AddCountVulnerabilityCritical(count int, vulnType vulnerability.Type) {
	...
	case vulnerability.Unknown:
		v.CriticalUnknown += count
	}
}
