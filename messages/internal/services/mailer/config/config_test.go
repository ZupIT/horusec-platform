...
func TestValidate(t *testing.T) {
	t.Run("should throw an error when the required environment variables is not set", func(t *testing.T) {
		_ = os.Unsetenv("HORUSEC_SMTP_ADDRESS")
		_ = os.Unsetenv("HORUSEC_SMTP_USERNAME")
		_ = os.Unsetenv("HORUSEC_SMTP_PASSWORD")
		_ = os.Unsetenv("HORUSEC_SMTP_HOST")
		_ = os.Unsetenv("HORUSEC_SMTP_PORT")
		_ = os.Unsetenv("HORUSEC_EMAIL_FROM")

		config := NewMailerConfig()
		err := config.Validate()

		assert.Error(t, err, "address: cannot be blank; host: cannot be blank; password:"+
			" cannot be blank; username: cannot be blank.")
	})

	t.Run("should return nil when the required environment variables is correctly setted", func(t *testing.T) {
		_ = os.Setenv("HORUSEC_SMTP_ADDRESS", "test")
		_ = os.Setenv("HORUSEC_SMTP_USERNAME", "test")
		_ = os.Setenv("HORUSEC_SMTP_PASSWORD", "test")
		_ = os.Setenv("HORUSEC_SMTP_HOST", "test")
		_ = os.Setenv("HORUSEC_SMTP_PORT", "test")
		_ = os.Setenv("HORUSEC_EMAIL_FROM", "test")
