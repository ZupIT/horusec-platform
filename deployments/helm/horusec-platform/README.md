...
| components.analytic.container.image.tag | string | `"v2.16.6"` | the reference to the Horusec Analytic container image version |
...
| components.api.container.image.tag | string | `"v2.16.6"` |  |
...
| components.auth.container.image.tag | string | `"v2.16.6"` |  |
...
| components.core.container.image.tag | string | `"v2.16.6"` |  |
...
| components.manager.container.image.tag | string | `"v2.16.6"` |  |
...
| components.messages.container.image.tag | string | `"v2.16.6"` |  |
...
| components.vulnerability.container.image.tag | string | `"v2.16.6"` |  |
...
| components.webhook.container.image.tag | string | `"v2.16.6"` |  |
