...
![Version: 1.0.0](https://img.shields.io/badge/Version-1.0.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.13.1](https://img.shields.io/badge/AppVersion-2.13.1-informational?style=flat-square)
...
| components.analytic.container.image.tag | string | `"v2.13.1"` | the reference to the Horusec Analytic container image version |
...
| components.api.container.image.tag | string | `"v2.13.1"` |  |
...
| components.auth.container.image.tag | string | `"v2.13.1"` |  |
...
| components.core.container.image.tag | string | `"v2.13.1"` |  |
...
| components.manager.container.image.tag | string | `"v2.13.1"` |  |
...
| components.messages.container.image.tag | string | `"v2.13.1"` |  |
...
| components.vulnerability.container.image.tag | string | `"v2.13.1"` |  |
...
| components.webhook.container.image.tag | string | `"v2.13.1"` |  |
