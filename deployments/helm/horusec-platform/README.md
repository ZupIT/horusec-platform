...
| components.analytic.container.image.tag | string | `"v2.16.7"` | the reference to the Horusec Analytic container image version |
...
| components.api.container.image.tag | string | `"v2.16.7"` |  |
...
| components.auth.container.image.tag | string | `"v2.16.7"` |  |
...
| components.core.container.image.tag | string | `"v2.16.7"` |  |
...
| components.manager.container.image.tag | string | `"v2.16.7"` |  |
...
| components.messages.container.image.tag | string | `"v2.16.7"` |  |
...
| components.vulnerability.container.image.tag | string | `"v2.16.7"` |  |
...
| components.webhook.container.image.tag | string | `"v2.16.7"` |  |
