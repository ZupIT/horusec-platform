...
| components.analytic.container.image.tag | string | `"v2.12.0"` | the reference to the Horusec Analytic container image version |
...
| components.api.container.image.tag | string | `"v2.12.0"` |  |
...
| components.auth.container.image.tag | string | `"v2.12.0"` |  |
...
| components.core.container.image.tag | string | `"v2.12.0"` |  |
...
| components.manager.container.image.tag | string | `"v2.12.0"` |  |
...
| components.messages.container.image.tag | string | `"v2.12.0"` |  |
...
| components.vulnerability.container.image.tag | string | `"v2.12.0"` |  |
...
| components.webhook.container.image.tag | string | `"v2.12.0"` |  |
