...
func (m *Mock) FindAnalysisByID(_ context.Context, _ uuid.UUID) response.IResponse {
	args := m.MethodCalled("FindAnalysisByID")
	return args.Get(0).(response.IResponse)
}
func (m *Mock) CreateFullAnalysis(_ context.Context, analysisArgument *analysis.Analysis) error {
